<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo $breadcrumb['0']['url']?>" class="nav-link"><?php echo $breadcrumb['0']['label']?></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo $breadcrumb['1']['url']?>" class="nav-link"><?php echo $breadcrumb['1']['label']?></a>
      </li>
    </ul>
