            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="card-footer">
                  <button id="btnSendDiscord" class="btn btn-primary">Submitd</button>
                </div>
            </div>
            <!-- /.card -->
...
<script src="/assets/adminlte/padinets/discords.js"></script>
<script>
$(function () {
  bsCustomFileInput.init();
});
$("#btnSendDiscord").click(function(){
    console.log("HEHE")
    sendDiscord({
        "kdticket":"hehe","clientname":"hoho","complaint":"haha","reporter":"hiho","reporterphone":"hahay"
    },"puji")
})
</script>
</body>
