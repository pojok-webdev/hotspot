...
<head>
  ...
  <title>Image Server | Gallery</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Show Images</a>
      </li>
    </ul>
              ...
              <div class="card-body">
                <div>
                  ...
                  <div class="mb-2">
                    ...
                    <button class="btn" id="btnUpload">Upload Gambar</button>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="#">Image Server</a>.</strong> All rights reserved.
  </footer>
...
<!-- Filterizr-->
<script src="/assets/adminlte/plugins/filterizr/jquery.filterizr.min.js"></script>
