...
<head>
  ...
  <title>Hotspot Manajemen | Registrasi</title>
  <?php $this->load->view('commons/registerheader');?>
</head>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Group</label>
                  <select class="form-control select2" style="width: 100%;" id="group">
              ...
              <button class="btn btn-default" id="btnSave">Simpan</button>
              <!-- /.col -->
            </div>
            <!-- /.row -->
...
<script>
  $(function () {
    $('#btnSave').click(function(){
      console.log("Save lho ya ...")
      $.ajax({
        url:'/otentikasi/create',
        type:'post',
        dataType:'json',
        data:{
          name:$('#name').val(),
      ...
      .fail(err=>{
        console.log('fail create user',err)
      })
    })
    }
  )
