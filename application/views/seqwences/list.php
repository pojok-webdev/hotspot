...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Seqwences</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
      <a class="nav-link" data-widget="navbar-settings" href="#" role="button">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="https://database.padinet.com">Hotspot</a>.</strong> All rights reserved.
  </footer>
...
<script src="/assets/padilibs/superkampret.js"></script>
<!-- Page specific script -->
<script>
  $(function () {
    clink = _=>{
    console.log('clink')
    var tblrincian = $("#tbluser").DataTable({
    "responsive": true, "lengthChange": false, "autoWidth": false,
    "ajax":'/seqwences/get_datas',
    "dom":"Bfrtip",
    "buttons":[
              "excel",
              {
                text: 'Penambahan Seqwence',
  ...
  clink()
  $("#tbluser").on('click','.btnedit',function(){
    $('#tbluser tr').removeClass('selected')
    tr = $(this).stairUp({level:2})
    console.log('edit wooii',tr.html())
    tr.addClass('selected')
    $('#txtEditName').val(tr.find('.name').html())
    $('#txtEditEmail').val(tr.find('.email').html())
    $('#txtEditGroup').val(tr.find('.group_id').html())
    $('#editUser').modal()
  })
  $('#btnSave').click(function(){
    console.log("test btnSave")
    $.ajax({
      url:'/users/update',
      data:{
        name:$('#txtEditName').val(),email:$('#txtEditEmail').val()
      },
      type:'post',
      dataType:'json'
    })
