...
<head>
  ...
  <title>Pengaturan Brand Sponsor</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Brand Sponsor</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Brand Sponsor <?php echo $sponsor_id;?></h1>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <img src="/uploads/sponsors/<?php echo $img;?>" alt="<?php echo $img;?>">
                    <button class="btn btn-warning btnsetimage" id="<?php echo $img;?>" >Gunakan</button>
                    <button class="btn btn-danger btnremoveimage" img="<?php echo $img;?>" >Hapus</button>
                    </div>
                    <?php }?>
...
<script>
  ...
  $('.btnsetimage').click(function(){
    $.ajax({
      ...
      data:{
        ...
        role:'brand'+'<?php echo $sponsor_id;?>'
      }
    })
    .done(res=>{
  ...
  $('.btnremoveimage').click(function(){
    ...
    .done(res=>{
      if(res>0){
        alert('image tidak dapat dihapus karena dipergunakan ')
      }else{
        console.log('Busa duoaous')
      }
    })
    .fail(err=>{})
  })
